...
//Match - O match() é um método de strings que pode receber como argumento uma Regexp. Existe uma diferença de resultado quando utilizamos a flag g ou não.
// const regexp = /\w{2,}/g;
...
//Split - O split serve para distribuirmos uma string em uma array, quebrando a string no argumento que for passado. Este método irá remover o match da array final.
...
//Replace - O método replace() é o mais interessante por permitir a utilização de funções de callback para cada match que ele der com a Regexp.
// const tags = `
// <ul>
//   <li>Item 1</li>
//   <li>Item 2</li>
...
//Captura - É possível fazer uma referência ao grupo de captura dentro do argumento do replace. Então podemos utilizar $&, $1 e mais.
// const tags = `
// <ul>
//   <li>Item 1</li>
//   <li>Item 2</li>
...
//Callback - Para substituições mais complexas, podemos utilizar um callback como segundo argumento do replace. O valor do return será o que irá substituir cada match.
// const regexp = /(\w+)(@[\w]+)/g;
...
//match
const regexp41 = /\w{2,}/g;
const regexpSemG = /\w{2,}/;
const frase9 = 'JavaScript, TypeScript e CoffeeScript';

frase9.match(regexp41);
// ['JavaScript', 'TypeScript', 'CoffeeScript']

frase9.match(regexpSemG);
// ["JavaScript", index: 0, input: "JavaScript,
// TypeScript e CoffeeScript", groups: undefined]

//split
const frase10 = 'JavaScript, TypeScript, CoffeeScript';
frase10.split(', ');
// ["JavaScript", "TypeScript", "CoffeeScript"]
frase10.split(/Script/g);
// ["Java", ", Type", ", Coffee", ""]
...
tagssss.replace(/<li/g, '$& class="ativo"');
// <ul>
//   <li class="ativo">Item 1</li>
//   <li class="ativo">Item 2</li>
// </ul>
...
emailss.replace(/(\w+@)[\w.]+/g, '$1gmail.com');
// empresa@gmail.com
// contato@gmail.com
// suporte@gmail.com

//callback
const regexp42 = /(\w+)(@[\w]+)/g;
const emailsss = `joao@homail.com.br
marta@ggmail.com.br
bruna@oulook.com.br`

emailsss.replace(regexp42, function(...args) {
  console.log(args);//grupos de captura estão aqui
  if(args[2] === '@homail') {
    return `${args[1]}@hotmail`;
  } else if(args[2] === '@ggmail') {
    return `${args[1]}@gmail`;
