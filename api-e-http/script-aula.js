...
//HTTP - Hypertext Transfer Protocol é o protocolo utilizando para enviarmos/recebermos arquivos e dados na Web.
...
//GET - GET irá puxar as informações da URL. Não é necessário informar que o método é GET, pois este é o padrão.
// const url = 'https://jsonplaceholder.typicode.com/posts/';
// fetch(url, {
//   method: 'GET'
// })
...
//POST - POST irá criar uma nova postagem, utilizando o tipo de conteúdo especificado no headers e utilizando o conteúdo do body.
// const url = 'https://jsonplaceholder.typicode.com/posts/';
// fetch(url, {
//   method: 'POST',
//   headers: {
...
//PUT - PUT irá atualizar o conteúdo do URL com o que for informado no conteúdo do body.
...
//HEAD - HEAD puxa apenas os headers. É uma requisição mais leve pois não puxa o body.
// const url = 'https://jsonplaceholder.typicode.com/posts/1/';
// fetch(url, {
//   method: 'HEAD',
// })
...
//CORS - Cross-Origin Resource Sharing, gerencia como deve ser o compartilhamento de recursos entre diferente origens.
...
//   method: 'HEAD',
// }).then(response => {
//     console.log(response.headers.get('Content-Type'))//Headers tem vários métodos que podem ser acessados, um deles é o get que puxa qualquer header informado.
// })